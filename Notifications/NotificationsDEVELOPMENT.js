...
var MasterId = "";
var Subscribers = [];
var DatabaseNode = "Development"; //current DB node

var notifRef = firebase.database().ref(DatabaseNode+"/NotificationIds");
    notifRef.on('value', snapshot => { 
        Subscribers = [];
        console.log("Reprocess Notification Ids...");
        getIds();
});
...
function getIds() {
    //-----Get IOS Subscribers-----// +
    console.log("Retrieving Notification Ids...");
                ...
                if(subscriber.Id == reciever) {
                 ...
                 if(subscriber.Type == "IOS") {
                       ...
                       if (message.length > 50) {
                        ...
                        SendIOSNotification(subscriber.NotificationId, subscriber.Name +":\n "+croppedMessage , 'ping.aiff', "DDM"+sender, 3 );
                    } 
                        ...
                        SendAndroidNotification(subscriber.NotificationId, subscriber.Name, croppedMessage, "DDM"+sender);
                    }
                } 
            });
         }
